...
public class Bootstrapper extends JFrame
{
    ...
    /* Kademlia instance */
    JSocialKademliaNode bootstrapInstance;
    ...
    public void launchBootstrapNode()
    {
        ...
        catch (IOException | ClassNotFoundException ex)
        {
            ...
            try
            {
                ...
                this.bootstrapInstance = new JSocialKademliaNode(BOOTSTRAP_OWNER_ID, new KademliaId("BOOTSTRAPBOOTSTRAPBO"), BOOTSTRAP_NODE_PORT);
            }
